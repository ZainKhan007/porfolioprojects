...
function completeNote() {
  ...
  var alterCompletion = (id==="todo")?document.getElementById('completed'):document.getElementById('todo');

  parent.removeChild(list);
  alterCompletion.insertBefore(list,alterCompletion.childNodes[0]);
}

function addItemTodu(text){
